...
import drawCompletedTemplate from "./templates/email-draw-completed.html";
import groupCreatedTemplate from "./templates/email-group-created.html";
import inviteTemplate from "./templates/email-invite.html";
import secretMessageTemplate from "./templates/email-secret-message.html";
import welcomeTemplate from "./templates/email-welcome.html";
